...
export default function PdfDownloads() {
  const pdfs = [
    ...
    },
    {
      ...
      file: '/pdfs/Gift.pdf',
      cover:
        'https://www.shikkmo.com/storage/new-products-uploads/bamboogiftset.jpg',
    },
    {
      title: 'Gift Box Catalogue',
      file: '/pdfs/GiftBoxCatalog.pdf',
      cover:
        'https://static.vecteezy.com/system/resources/previews/011/720/981/original/black-gift-boxes-with-bow-free-png.png',
    },
    {
      title: 'Gift M Catalogue',
      file: '/pdfs/Giftm.pdf',
      cover:
        'https://littletimber.com.au/wp-content/uploads/2023/06/LT0623-80-1-1200x1200.jpg',
    },
    {
      title: 'HAK Catalogue',
      file: '/pdfs/HAK.pdf',
      cover:
        'https://images.pexels.com/photos/8872719/pexels-photo-8872719.jpeg',
    },
